...
Добавьте Streamable HTTP URL как MCP-коннектор и завершите OAuth. В Gemini Spark при необходимости загрузите архив навыка и используйте Replace skill для новой версии.
